...
$uuid_visita = uniqid('', true);
$fechaCreacion = date("Y-m-d H:i:s");
$result = mysqli_query($mysqli, "SELECT * FROM visitasgt WHERE ip_visitante = '$ip' ORDER BY fecha_creacion DESC LIMIT 1;");
...
if ($fechaCreacion == $fechaYHora){
    ...
    if ($horaAdelantada == $horaSisUtil){
        ...
        $sql = "INSERT INTO visitasgt (uuid_visita, ip_visitante) VALUES ('$uuid_visita', '$ip')";
