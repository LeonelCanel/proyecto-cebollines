      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarPromocion">Agregar Promoción</button>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    $contador = 0;
                    $result = mysqli_query($mysqli, "SELECT * FROM promociones;");
                    $contador = 0;
                ...
                ?>
                  <tr>
                    <td><?=$contador?></td>
                    <td style='width: 10%;'><?= $row['nombre_promocion'];?></td>
                    <td style='width: 30%;'><?= $row['descripcion_promocion'];?></td>
                    <td><img src="<?= $row['url_imagen_promocion'];?>" style="width:30%;" alt=""></td>
                    <td style='width: 15%;'>

                      <!-- Editar -->
                      <a class="btn btn-success btn-circle" href="editarPromocion.php?id_promocion=<?= $row['id_promocion'];?>">
                          <i class="fas fa-edit"></i>
                      </a> 

                      <!-- Eliminar -->
                      <a class="btn btn-danger btn-circle" href="eliminarPromocion.php?id_promocion=<?= $row['id_promocion']; ?>">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" action="configPromociones.php" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <label>Nombre de la Promoción</label>
             <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nombre_promocion" placeholder="Ingresar nombre de la Promoción" id="nombre_promocion" required>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="input-group">
                <input type="text" class="form-control input-lg" name="descripcion" placeholder="Ingresar descripción" id="descripcion" required>
              </div>
            </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" name="registrarPromocion">Guardar Promoción</button>
