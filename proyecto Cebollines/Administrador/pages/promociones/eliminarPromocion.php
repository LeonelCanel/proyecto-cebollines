            ...
            <div class="card card-danger">
              ...
              <form role="form" method="post" action="configPromociones.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="id_promocion" id="id_promocion" value="<?= $row['id_promocion'];?>" readonly>
                                <input type="text" class="form-control" name="nombre_promocion" id="nombre_promocion" value="<?= $row['nombre_promocion'];?>" readonly> 
                            </div>   
                        </div>
                        <div class="col">
                            <label for="exampleInputEmail1">Descripción del Ítem</label>
                            <input type="text" class="form-control" name="descripcion" id="descripcion" value="<?= $row['descripcion_promocion'];?>" readonly> 
                        </div>
                    </div>
                ...
                <div class="card-footer">
                  ...
                  <button type="submit" class="btn btn-primary" name="eliminarPromociones">Eliminar promoción</button>
                </div>
              </form>
              <?php } ?>
            </div>
