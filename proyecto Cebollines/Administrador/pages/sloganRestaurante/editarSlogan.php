            ...
            <div class="card card-primary">
              ...
              <form role="form" method="post" action="configSlogan.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre_restaurante" id="nombre_restaurante" value="<?= $row['nombre_restaurante'];?>"> 
                            </div>   
                        </div>
                        <div class="col">
                            <label for="exampleInputEmail1">Teléfono Restaurante</label>
                            <input type="text" class="form-control" name="telefono" id="telefono" value="<?= $row['telefono_restaurante'];?>"> 
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="slogan" name="slogan" rows="3"><?= $row['slogan_restaurante'];?></textarea>
                            </div>   
                        </div>
                        <div class="col"><br><br>
                ...
                <div class="card-footer" style="margin-left: 70%">
                  ...
                  <button type="submit" class="btn btn-success" name="editarSlogan">Guardar Cambios</button>
                </div>
              </form>
              <?php } ?>
            </div>
