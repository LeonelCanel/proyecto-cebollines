      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarCarrusel">Agregar Imagen</button>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <div class="card-body">
                <div class="row">
                  <?php 
                      ...
                      $result = mysqli_query($mysqli, "SELECT * FROM carruselgt");
                      while ($row = mysqli_fetch_assoc($result)):
                  ?>

                  <div class="col">
                    <div class="card" style="width: 15rem;">
                      <h3 style="text-align: center;"><b><?= $row['nombre_carrusel_gt'];?></b></h3>
                        <img class="card-img-top" src="<?= $row['ruta_carrusel_gt'];?>" alt="Card image cap">                            
                    </div>
                    <!-- botones de accion en los menu -->
                    <div class="col">
                      <a class="btn btn-success" href="editarCarrusel.php?uuid_carrusel_gt=<?= $row['uuid_carrusel_gt'];?>">
                        <i class="fas fa-edit"></i>
                      </a> 
                      <a class="btn btn-danger" href="eliminarCarrusel.php?uuid_carrusel_gt=<?= $row['uuid_carrusel_gt'];?>">
...
<div id="modalAgregarCarrusel" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" action="configCarrusel.php" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" name="registrarCarrusel">Guardar usuario</button>
