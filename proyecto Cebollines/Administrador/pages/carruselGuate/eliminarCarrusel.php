            ...
            <div class="card card-danger">
              ...
              <!-- form start -->
                ...
                <?php
                    ...
                    $uuid_carrusel_gt = $_GET['uuid_carrusel_gt'];
                    $sql = "SELECT * FROM carruselgt WHERE uuid_carrusel_gt = '".$uuid_carrusel_gt."'";
              ...
              <form role="form" method="post" action="configCarrusel.php" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="uuid_carrusel_gt" id="uuid_carrusel_gt" value="<?= $row['uuid_carrusel_gt'];?>"> 
                                <input type="text" class="form-control" name="nombre_carrusel_gt" id="nombre_carrusel_gt" value="<?= $row['nombre_carrusel_gt'];?>"> 
                            </div>   
                        </div>                    
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Imagen Carrusel</label>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary" name="eliminarCarrusel">Eliminar Carrusel</button>
                </div>
              </form>
              <?php } ?>
            </div>
