            ...
            <div class="card card-danger">
              ...
              <form role="form" method="post" action="configMenu.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre_item" id="nombre_item" value="<?= $row['nombre_item'];?>" readonly> 
                            </div>   
                        </div>
                        <?php if ($row['contiene_descripcion'] == 0){ ?>
                        ...
                        <?php  } else { ?>
                          <div class="col">
                            ...
                            <div class="input-group">
                                <textarea class="form-control" id="ingredientes_item" name="ingredientes_item" rows="3" readonly><?= $row['descripcion_item']; ?></textarea>
                            </div>
                            </div>
                          </div>
                        <?php }?>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="card" style="width: 18rem;">
                                    <img class="card-img-top" src="<?= $row['url_imagen_item'];?>">
                                </div>
                            </div>   
                        </div>
                    </div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-danger" name="eliminarItem">Eliminar Ítem</button>
                </div>
              </form>
              <?php } ?>
            </div>
