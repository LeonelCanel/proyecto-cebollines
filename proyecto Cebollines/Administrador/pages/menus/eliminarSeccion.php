...
<!--                     <div class="row">
                ...
                <div class="card-footer" >
                    ...
                    <a class="btn btn-danger" href="agregarSecciones.php?uuid_menu=<?= $regreso;?>">
                        <i class="far fa-arrow-alt-circle-left"></i>
                        Cancelar
                    </a>
                  <button type="submit" class="btn btn-success" name="eliminarSeccion">Eliminar Sección</button>
                </div>
              </form>
              <?php } ?>
            </div>
