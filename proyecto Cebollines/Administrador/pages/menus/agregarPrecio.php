  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Agregar precio a  <b><?= $row['nombre_item'];?> </b></h1><br>
            ...
            <div class="card card-info">
              ...
              <div class="card-body">
                <?php 
                  include '../conexion/conexion.php';
                  $uuid_item = $_GET['uuid_item'];
                  $sql = "SELECT  * FROM precios WHERE uuid_item = '".$uuid_item."'";
                  $resultado=mysqli_query($mysqli, $sql);
                  while ($row = mysqli_fetch_assoc($resultado)){
                      
                ?>
                    <form role="form" method="post" action="configMenu.php">
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="precio_regular" name="precio_regular" placeholder="Ingresa el precio Regular" required value="<?= $row['precio_normal'];?>" >
                                    <input type="hidden"id="uuid_item" name="uuid_item" value="<?= $uuid_item?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="precio_doble" name="precio_doble" placeholder="Ingresa el precio Doble" value="<?=  $row['precio_doble'];?>" >
                                </div>
                            </div>
                            <div class="col-sm">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="precio_promocion" name="precio_promocion" placeholder="Ingresa el precio de Promoción" value="<?=  $row['precio_promocion'];?>">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" name="registrarPrecio">Agregar Precio</button>
                        </div>
                    </form>
                    <?php } ?>
