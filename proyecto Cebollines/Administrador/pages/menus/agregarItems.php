...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php 
        ...
        $sql = "SELECT nombre_item, url_imagen_item, descripcion_item, nombre_seccion FROM items t1 INNER JOIN secciones t2 where t2.uuid_seccion = '".$uuid_seccion."'";
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <?php
            include '../conexion/conexion.php';
            $uuid_seccion = $_GET['uuid_seccion'];
            $sql = "SELECT * FROM secciones WHERE uuid_seccion = '".$uuid_seccion."'";
            $resultado=mysqli_query($mysqli, $sql);
            while ($rowRegreso = mysqli_fetch_assoc($resultado)){
                $regreso = $rowRegreso['uuid_menu'];
            }
          ?>
            <h1>Items de la Sección de <?= $nombreSeccion?></h1><br>
            <a class="btn btn-success" href="agregarSecciones.php?uuid_menu=<?= $regreso;?>">
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="row">
                        <?php 
                            include '../conexion/conexion.php';
                            $result = mysqli_query($mysqli, "SELECT i.uuid_item, i.nombre_item, i.url_imagen_item, i.descripcion_item, i.uuid_seccion, p.precio_normal, p.precio_doble, p.precio_promocion, p.item_contiene_precio FROM items i INNER JOIN precios p ON i.uuid_item = p.uuid_item WHERE i.uuid_seccion = '".$uuid_seccion."'");
                        ...
                        <div class="col">
                          <div class="card" style="width: 15rem;">
                            ...
                            <b><h3 style="text-align: center; ">Q. <?= $row['precio_normal'];?></h3></b>
                          ...
                          <div class="col">
                                ...
                                <a class="btn btn-warning" href="agregarPrecio.php?uuid_item=<?= $row['uuid_item'];?>">
                                  <i class="far fa-money-bill-alt"></i>
                                </a>
                                <a class="btn btn-info" href="quitarPrecio.php?uuid_item=<?= $row['uuid_item'];?>">
                        ...
                        <?php } else {  ?>
                          ...
                          <div class="col">
                                ...
                                <a class="btn btn-info" href="colocarPrecio.php?uuid_item=<?= $row['uuid_item'];?>">
