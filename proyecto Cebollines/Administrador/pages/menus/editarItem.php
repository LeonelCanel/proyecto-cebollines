                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre_item" id="nombre_item" value="<?= $row['nombre_item'];?>"> 
                            </div>   
                        </div>
                        <div class="col">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control" id="descripcion" name="descripcion" rows="5" ><?= $row['descripcion_item'];?></textarea>
                            </div>
                            </div>
                        </div>
                    </div>
