    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Menús</h1><br>
            <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarMenu">
              ...
              <div class="card-body">
                <div class="container">
                  <div class="row justify-content">
                      ...
                      ?> 
                      <?php if ($row['secciones'] == 1){ ?>
                        <div class="col-md-auto" style="margin-top:3%;">  
                          <a href="agregarSecciones.php?uuid_menu=<?= $row['uuid_menu'];?>">
                            <div class="card" style="background-color: #f8981d; width: 100%;">
                              <div class="card-body">
                                <h1 style="color:white; text-align: center;"><?= $row['nombre_menu'];?></h1>
                              </div>
                            </div>
                          </a>
                        </div>
                        <div class="col-md-auto" style="margin-top:3%;" >
                          <a class="btn btn-success" href="editarMenu.php?uuid_menu=<?= $row['uuid_menu'];?>">
                            <i class="fas fa-edit"></i>
                          </a> 
                          <br><br>
                          <a class="btn btn-danger" href="eliminarMenu.php?uuid_menu=<?= $row['uuid_menu'];?>">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" action="configMenu.php" enctype="multipart/form-data">
            ...
            <label>Nombre del Menú</label>
             <div class="form-group">
              <div class="input-group">
                <input type="text" class="form-control input-lg" name="nombre_menu" placeholder="Ingrese el Nombre del Menú" id="nombre_menu" required>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" name="registrarMenu">
