            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                ...
                <?php
                    ...
                    $sql = "SELECT uuid_usuario, usuario, nombres_usuario, apellidos_usuario, correo, tipo_rol FROM usuarios INNER JOIN rol ON usuarios.uuid_rol = rol.uuid_rol WHERE uuid_usuario = '".$id."'";
              ...
              <form role="form" method="post" action="configUsuarios.php">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="uuid_usuario" id="uuid_usuario" value="<?= $row['uuid_usuario'];?>" readonly> 
                                <input type="text" class="form-control" name="nombres" id="nombres" value="<?= $row['nombres_usuario'];?>" readonly> 
                            </div>   
                        </div>
                        <div class="col">
                            <label for="exampleInputEmail1">Apellidos de Usuario</label>
                            <input type="text" class="form-control" name="apellidos" id="apellidos" value="<?= $row['apellidos_usuario'];?>" readonly> 
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="usuario" id="usuario" value="<?= $row['usuario'];?>" readonly> 
                            </div>   
                        </div>
                    </div>
                ...
                <div class="card-footer" style="margin-left: 70%">
                  ...
                  <button type="submit" class="btn btn-success" name="cambioContraseña">Guardar Cambios</button>
                </div>
              </form>
              <?php } ?>
            </div>
