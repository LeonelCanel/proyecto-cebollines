            ...
            <div class="card card-danger">
              ...
              <form role="form" method="post" action="configUsuarios.php">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="email" class="form-control" name="correo" id="correo" value="<?= $row['correo'];?>" readonly> 
                        </div>
                    </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer" style="margin-left: 70%">
                  ...
                  <button type="submit" class="btn btn-success" name="eliminarRegistro">Guardar Cambios</button>
                </div>
              </form>
              <?php } ?>
            </div>
