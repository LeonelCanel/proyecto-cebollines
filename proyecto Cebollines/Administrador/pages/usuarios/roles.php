    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Usuarios</h1><br>
            <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarRol"><i class="fas fa-plus"></i>   Agregar Rol</button>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    $contador = 0;
                    $result = mysqli_query($mysqli, "SELECT * FROM rol;");
                    $contador = 0;
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <!-- Editar -->
                      <a class="btn btn-success btn-circle" href="editar_rol.php?uuid_rol=<?= $row['uuid_rol'];?>">
                          <i class="fas fa-edit"></i>
                      </a> 

                      <!-- Eliminar -->
                      <a class="btn btn-danger btn-circle" href="eliminar_rol.php?uuid_rol=<?= $row['uuid_rol']; ?>">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" action="configUsuarios.php">
            ...
            <label>Nombre del Rol</label>
             <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="rol" placeholder="Ingrese un nuevo Rol" id="rol" required>
              </div>
            </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" name="registrar_rol">
          <i class="far fa-save"></i>   Guardar Rol</button>
