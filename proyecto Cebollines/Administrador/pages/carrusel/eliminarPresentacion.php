              ...
              <form role="form" method="post" action="configPresentacion.php" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Mensaje de la Presentación</label>
                                <input type="hidden" class="form-control" name="id_presentacion" id="id_presentacion" value="<?= $row['id_presentacion'];?>"> 
                                <input type="text" class="form-control" name="mensaje_presentacion" id="mensaje_presentacion" value="<?= $row['mensaje_presentacion'];?>"> 
                            </div>   
                        </div>                    
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Imagen Menú</label>
                                <div class="card" style="width: 18rem;">
                                    <img class="card-img-top" src="<?= $row['url_imagen_presentacion'];?>" alt="Card image cap">
                                </div>
                            </div>   
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="eliminarPresentacion">Eliminar Presentación</button>
                </div>
              </form>
              <?php } ?>
            </div>
