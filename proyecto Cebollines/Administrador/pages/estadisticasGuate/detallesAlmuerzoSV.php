              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    INNER JOIN menusv m ON s.uuid_menu_sv = m.uuid_menu_sv WHERE precio_normal_sv <> 0 AND m.uuid_menu_sv = '61dd212364f312.28490463'
                    ORDER BY p.precio_normal_sv DESC");
                    $contador = 0;
                ...
                ?>
                  <tr>
                    <td><?=$contador?></td>
                    <td><?= $row['nombre_menu_sv'];?></td>
                    <td><?= $row['nombre_seccion_sv'];?></td>
                    <td><?= $row['nombre_item_sv'];?></td>
                    <td><?= $moneda?></td>
                    <td><?= $row['precio_normal_sv'];?></td>
                    <td><?= $row['precio_doble_sv'];?></td>
                  </tr>
                  <?php endwhile?>
                  </tbody>
                </table>
