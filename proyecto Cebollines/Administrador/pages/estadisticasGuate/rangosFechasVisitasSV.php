  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Rangos de Fechas Salvador</h1><br>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    if( isset($_POST['consultar'] )){
                        ...
                        $contador = 0;
                        $result = mysqli_query($mysqli, "SELECT * FROM visitassv WHERE fecha_creacion BETWEEN '$fechaI' AND '$fechaF'");
                        $contador = 0;
                    }
