          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">¿Esta seguro que desea eliminar este menú?</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <form role="form" method="post" action="configMenuSV.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="uuid_menu_sv" id="uuid_menu_sv" value="<?= $row['uuid_menu_sv'];?>"> 
                                <input type="text" class="form-control" name="nombre_menu_sv" id="nombre_menu_sv" value="<?= $row['nombre_menu_sv'];?>"> 
                            </div>   
                        </div>
                    </div>
                </div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-danger" name="eliminarMenuSV">
