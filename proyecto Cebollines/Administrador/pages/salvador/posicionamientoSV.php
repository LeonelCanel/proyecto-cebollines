  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Posicionamiento <?= $row['nombre_menu_sv'];?></h1><br>
            <a class="btn btn-success" href="agregarSeccionesSV.php?uuid_menu_sv=<?= $uuid_menu_sv;?>">
            ...
            <div class="card">
              ...
              <div class="row">
                        <?php if($esDomicilio == true){ ?>
                          <?php
                            include '../conexion/conexion.php';
                            $result = mysqli_query($mysqli, "SELECT * FROM domicilios WHERE uuid_menu_sv = '".$uuid_menu_sv."'");
                        ...
                        <?php
                              ...
                              while ($row = mysqli_fetch_assoc($result)):
                                $uuid_modal = substr($row['uuid_seccion_sv'], 0, 14);
                          ...
                          <?php if ($row['nombre_seccion_sv'] == 'PROMOCIONES CLUB BI') { ?> 
                              ...
                              <div class="col-sm-4">
                                <div class="card" style="width: 12rem;">
                                  ...
                                  <a href="editarPosicionSV.php?uuid_seccion_sv=<?= $uuid_seccion_sv;?>">
                                    <img class="card-img-top" src="<?= $row['ruta'];?>" alt="Card image cap">
                          ...
                          <?php } else { ?>
                              ...
                              <div class="col-sm-4" style="margin-top: 3%;">
                                <div class="card" style="background-color: #f8981d; width: 100%;">
                                  <a href="editarPosicionSV.php?uuid_seccion_sv=<?= $uuid_seccion_sv;?>" style="background: transparent; border: none !important; font-size:0; color: white;">
                                    <div class="card-body">
